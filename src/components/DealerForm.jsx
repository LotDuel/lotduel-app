...
export default function DealerForm() {
        ...
        <div style={{ maxWidth: 520, width: "100%", textAlign: "center" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: "22px 28px", border: "1px solid var(--border)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span style={{ color: "#f1f5f9", fontSize: 15, fontWeight: 500 }}>{form.year} RAV4 Hybrid {form.trim}</span>
            </div>
          </div>
        </div>
      </div>
  ...
  const req = <span style={{ color: "var(--red)", marginLeft: 3 }}>*</span>;
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", padding: "48px 20px", fontFamily: "var(--font)" }}>
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", borderRadius: 14, padding: "22px 28px", marginBottom: 36, border: "1px solid var(--border)" }}>
          ...
          <div style={{ color: "#f1f5f9", fontSize: 22, fontWeight: 800, letterSpacing: "-0.02em" }}>2022–2023 Toyota RAV4 Hybrid</div>
          <div style={{ color: "#94a3b8", fontSize: 14, marginTop: 6 }}>Under 40,000 miles · Within 60 mi of Lake Stevens, WA</div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <div>
              <label style={lbl}>Trim{req}</label>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              <label style={lbl}>Mileage{req}</label>
            ...
            <div>
              <label style={lbl}>OTD Price{req}</label>
              <input type="text" placeholder="e.g. 28500" value={form.otd} onChange={(e) => setForm({ ...form, otd: e.target.value.replace(/[^0-9]/g, "") })} style={inp(errors.otd)} />
            </div>
          </div>
          <div>
            <label style={lbl}>Certified Pre-Owned?{req}</label>
        ...
        <button onClick={() => { if (validate()) setSubmitted(true); }} className="landing-cta" style={{
